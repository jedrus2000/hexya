...
func SetHexyaFlags(c *cobra.Command) {
	...
	c.PersistentFlags().StringSliceP("modules", "m", []string{"github.com/jedrus2000/hexya/addons/web"}, "List of module paths to load. Defaults to ['github.com/jedrus2000/hexya/addons/web']")
